...
/*
-------------------------
FX_CloneBlasterProjectileThink
-------------------------
*/
...
void FX_CloneBlasterProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
{
	...
	theFxScheduler.PlayEffect( cgs.effects.cloneBlasterShotEffect, cent->lerpOrigin, forward );
}
...
{
	FX_CloneBlasterProjectileThink( cent, weapon );
}
...
{
	theFxScheduler.PlayEffect( cgs.effects.cloneBlasterWallImpactEffect, origin, normal );
}

/*
-------------------------
FX_CloneBlasterWeaponHitPlayer
-------------------------
*/
void FX_CloneBlasterWeaponHitPlayer( gentity_t *hit, vec3_t origin, vec3_t normal, qboolean humanoid )
{
	...
	theFxScheduler.PlayEffect( cgs.effects.cloneBlasterFleshImpactEffect, origin, normal );
}
